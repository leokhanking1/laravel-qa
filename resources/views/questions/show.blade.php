               ...
               <div class="card-body">
                ...
                <div class="media">
                    <div class="d-flex flex-column vote-controls">
                        ...
                        <a title="This question is not useful" class="vote-up off">
                            <i class="fas fa-caret-down fa-3x"></i>
                        </a>
                        <a title="Click to mark as favorite Question (Click again to undo)" class="favorite mt-2 favorited">
                            <i class="fas fa-star fa-2x"></i> <span class="favorite-count">123</span>
                        </a>
                    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="media">
                            <div class="d-flex flex-column vote-controls">
                                    ...
                                    <span class="votes-count">1230</span>
                                    <a title="This anser is not useful" class="vote-up off">
                                        <i class="fas fa-caret-down fa-3x"></i>
                                    </a>
